...
public class CobaltWhatsAppClientImpl implements WhatsAppClient {
  ...
  @Override
  public CompletableFuture<WhatsAppMessageInfo> sendMessage(Whatsapp api, String jid,
      String message, String quotedMessageJid, String quotedMessageId) {
    checkConnection(api);
    ...
    if (quotedOptionalMessage.isPresent()) {
      ...
      return api.sendChatMessage(jidProvider, message, quotedMessage)
          .thenApply(this::mapMessageInfo);
    } else {
